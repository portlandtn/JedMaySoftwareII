...
public class AppointmentTypeReportController implements Initializable {
    ...
    @FXML
    private RadioButton consulationRadioButton;

    @FXML
    private RadioButton introductionRadioButton;
    ...
    @FXML
    void onActionSelectConsultation(ActionEvent event) {

    }

    @FXML
    void onActionSelectIntroduction(ActionEvent event) {
